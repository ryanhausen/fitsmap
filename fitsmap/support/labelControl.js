...
L.Control.Label = L.Control.extend({
    ...
    onAdd: function () {
        ...
        // div.innerHTML = this.makeText(center.lat, center.lng);
    ...
    update: function () {
        const center = this.options.latlng;
        this.options.displayHTML.innerHTML = this.makeText(center.lng, center.lat);
    },
